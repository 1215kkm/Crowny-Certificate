  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        setError("등록되지 않은 이메일이거나 비밀번호가 틀립니다.");
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full border border-border py-3 rounded-lg font-medium hover:bg-muted transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
