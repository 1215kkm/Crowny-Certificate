  ...
  stages: [
...

    {
      ...
      paragraphs: [
        ...
        {
          kind: "what",
          text: "우리만의 한 가지는 「누구나 5초 안에 쓸 수 있게」예요. 로그인 없음, 설정 없음, 버튼 크게. 이것만 지키면 우리 앱은 존재 이유가 생깁니다.",
        },
        {
          kind: "what",
      ...
      cards: [
        {
          ...
          note: "너무 많아서 처음 쓰는 사람은 첫 화면에서 멈춥니다. 우리가 안 따라갈 방향.",
        },
        {
          title: "아이폰 「미리 알림」",
...
나중에 할 것: 알림, 날짜, 사진, 친구와 공유`,
...

    {
      ...
      paragraphs: [
        ...
        {
          kind: "what",
          text: "글자는 16px 밑으로 내려가지 않게 합니다. 12px 는 작아서 폰 화면이나 눈이 피로할 때는 읽기 힘들어요. 우리 앱은 최소 15px 입니다.",
        },
        {
          kind: "tip",
      ...
      cards: [
        ...
        {
          title: "② GPT 만 쓰기",
          body: "참고 자료 없이 말로만 부탁합니다. 「간단한 할 일 앱 디자인해줘」.",
...
저장: 브라우저 안에만 (로그인 없이 쓰려고)`,
  ...
  buildSteps: [
    ...
    },
    {
      id: "s1",
      title: "2. 첫 화면 띄우기",
      goal: "이제 오른쪽 미리보기에 「나의 할 일 앱」이라는 제목을 띄울 겁니다.",
    ...
    },
    {
      id: "s2",
      title: "3. 색 입히기",
      goal: "이제 배경을 연보라색으로, 제목을 보라색으로 바꿀 겁니다.",
    ...
    },
    {
      id: "s5",
      title: "6. 메뉴 버튼 만들기",
      goal: "이제 「할 일 / 통계 / 소개」 버튼 3개를 나란히 만들 겁니다.",
    ...
    },
    {
      ...
      goal: "이제 메뉴를 누르면 눌린 버튼에 보라색이 칠해지게 할 겁니다.",
    ...
    },
    {
      id: "s7",
      title: "8. 할 일 페이지 만들기",
      goal: "이제 「할 일」 버튼을 누르면 「오늘 할 일」이라는 빈 화면이 뜨게 할 겁니다.",
    ...
    },
    {
      id: "s8",
      title: "9. 입력창 만들기",
      goal: "이제 글자를 치면 아래에 친 글자가 그대로 따라 나오게 할 겁니다.",
    ...
    },
    {
      id: "s9",
      title: "10. 할 일 담기",
      goal: "이제 추가 버튼을 누르면 「지금까지 N개 담았어요」의 숫자가 올라가게 할 겁니다.",
    ...
    },
    {
      id: "s10",
      title: "11. 목록 보여주기",
      goal: "이제 추가한 할 일들을 줄줄이 목록으로 보여줄 겁니다.",
    ...
    },
    {
      id: "s11",
      title: "12. 완료 체크하기",
      goal: "이제 체크박스를 누르면 글자에 취소선이 그어지게 할 겁니다.",
    ...
    },
    {
      id: "s12",
      title: "13. 삭제하기",
      goal: "이제 삭제 버튼을 누르면 그 할 일이 사라지게 할 겁니다.",
    ...
    },
    {
      ...
      goal: "이제 「통계」 버튼을 누르면 전체·완료·남은 개수와 진행 막대가 나오게 할 겁니다.",
